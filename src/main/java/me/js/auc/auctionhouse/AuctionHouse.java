...
import me.js.auc.auctionhouse.commands.InitializeXconomy;
...
public final class AuctionHouse extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        Objects.requireNonNull(getCommand("auc")).setExecutor(new InitializeXconomy());
        Objects.requireNonNull(getCommand("balance")).setExecutor(new InitializeXconomy());
    }
    @Override
